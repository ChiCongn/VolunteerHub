...
// Import Component Modal mới (Giả sử bạn lưu ở đường dẫn này)
    ...
    return (
        <div className="min-h-screen bg-[#dae0e6] dark:bg-black">
            ...
            <CreatePostModal
                ...
                userAvatar="https://github.com/shadcn.png" // Bạn có thể thay bằng user hiện tại nếu có context
            />
                                    ...
                                    <Card className="shadow-sm border border-zinc-200">
                                        <div className="p-2 flex gap-2">
                                            ...
                                            <Input
                                                ...
                                                readOnly
                                                onClick={handleCreatePost} // Click mở Modal
                                            />
                                            <Button
                                                variant="ghost"
                                                size="icon"
