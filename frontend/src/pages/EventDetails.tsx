...
import { getUserById, categoryIcons, mockEvents } from "../lib/mockData";
                    ...
                    <Tabs defaultValue="details" className="w-full">
                        ...
                        <TabsContent value="details" className="space-y-4 pt-4">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-4">
                                    Join us for this amazing volunteer
                                    opportunity! This event is perfect for
                                    anyone looking to make a difference in the
                                    community. All skill levels are welcome, and
                                    we'll provide all necessary supplies and
                                    training.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                                    <li>
                                        Comfortable clothing and closed-toe
                                        shoes
                                    </li>
                        ...
                        >
                            <div className="text-center py-8 text-muted-foreground">
                                <p>
                                    No discussions yet. Be the first to start a
                                    conversation!
                                </p>
                            </div>
                        </TabsContent>
