...
export function ProfileCard({ user, onEdit, eventsAttended = 0, hoursVolunteered = 0 }: ProfileCardProps) {
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
            <div className="text-center">
              <p className="text-2xl font-semibold text-[#43A047]">{eventsAttended}</p>
              <p className="text-xs text-muted-foreground">Events Attended</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-semibold text-[#2196F3]">{hoursVolunteered}</p>
